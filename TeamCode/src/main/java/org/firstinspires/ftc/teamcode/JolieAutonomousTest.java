...
// driver station.
@Autonomous(name = "Jolie Autonomous Test")
//You can insert @Disabled if you don't want it to appear when you are choosing an Op mode.
public class JolieAutonomousTest extends LinearOpMode
{
    //Declare Motors
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        //One Motor from each pair has to be reversed so that the robot doesn't spin in a circle.
